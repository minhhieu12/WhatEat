        ...
        <View>
            <View style={{flexDirection: 'row', marginVertical: 5}}>
                <TouchableOpacity style={{flexDirection: 'row'}}>
                    ...
                    <Text style={{fontSize: 16, fontWeight: 'bold', marginTop: 15, marginLeft: 5, width: 228}}>Phước Trung</Text>
                </TouchableOpacity>
            ...
            <View style={{flexDirection: 'row', marginVertical: 5}}>
                <TouchableOpacity style={{flexDirection: 'row'}}>
                    ...
                    <Text style={{fontSize: 16, fontWeight: 'bold', marginTop: 15, marginLeft: 5, width: 228}}>Minh Nghĩa</Text>
                </TouchableOpacity>
                <TouchableOpacity style={{backgroundColor: '#00b060', paddingHorizontal: 15, height: 25, borderRadius: 8, marginTop: 15}}>
                    <Text style={{color: 'white', marginTop: 2}}>Theo dõi</Text>
                </TouchableOpacity>
            ...
            <View style={{flexDirection: 'row', marginVertical: 5}}>
                <TouchableOpacity style={{flexDirection: 'row'}}>
                    ...
                    <Text style={{fontSize: 16, fontWeight: 'bold', marginTop: 15, marginLeft: 5, width: 228}}>Thành Đạt</Text>
                </TouchableOpacity>
                <TouchableOpacity style={{backgroundColor: '#00b060', paddingHorizontal: 15, height: 25, borderRadius: 8, marginTop: 15}}>
                    <Text style={{color: 'white', marginTop: 2}}>Theo dõi</Text>
                </TouchableOpacity>

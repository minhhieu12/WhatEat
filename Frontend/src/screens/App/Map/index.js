...
function Map() {
    ...
    return (
        <View>
            ...
            <View style={{height: 120, borderRadius: 8, marginHorizontal: 4, backgroundColor: 'rgba(52, 52, 52, 0.4)', marginTop: -640}}>
                <View style={{flexDirection: 'row', marginTop: 3, marginHorizontal: 5}}>
                    <View style={{backgroundColor: 'white', marginHorizontal: 5, marginVertical: 5, borderRadius: 8, flexDirection: 'row', height: 40}}>
                        <TextInput style={{width: 238, marginHorizontal: 5, fontSize: 12}} placeholder="Nhập tên món ăn hoặc địa điểm"></TextInput>
                        <TouchableOpacity>
